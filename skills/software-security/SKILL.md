...
description: Software security workflow integrating Project CodeGuard rules to help write and review secure code, prevent common vulnerabilities, and apply secure-by-default patterns. Use when writing new code, reviewing or modifying existing code, implementing security-sensitive features (authn, crypto, data handling), working with user input/databases/APIs, or configuring cloud/CI-CD/containers.
---

# Software Security (Project CodeGuard)

This workflow provides comprehensive security guidance to help generate secure code and prevent common vulnerabilities. It is based on **Project CodeGuard**, an open-source, model-agnostic security framework that embeds secure-by-default practices into AI coding workflows.
...
This workflow should be activated when:
...
- [./software-security/rules/codeguard-1-hardcoded-credentials.md](./software-security/rules/codeguard-1-hardcoded-credentials.md) - Never hardcode secrets, passwords, API keys, or tokens
- [./software-security/rules/codeguard-1-crypto-algorithms.md](./software-security/rules/codeguard-1-crypto-algorithms.md) - Use only modern, secure cryptographic algorithms
- [./software-security/rules/codeguard-1-digital-certificates.md](./software-security/rules/codeguard-1-digital-certificates.md) - Validate and manage digital certificates securely
2. Context-Specific Rules: Apply rules from the [./software-security/rules/](./software-security/rules/) directory based on the language of the feature being implemented using the table given below:
...
The security rules are available in [./software-security/rules/](./software-security/rules/).
