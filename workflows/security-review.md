---
description: Comprehensive security code review workflow for a target repository, producing a markdown report with findings and recommendations. Use when user requests a full codebase security review, asks for prioritized security findings with remediation guidance, or wants a formal security audit report. Powered by Project CodeGuard (CoSAI/OASIS).
---
...
1. Load the security knowledge base from Project CodeGuard
   - First read [./security-review/Security_Code_Reviewer_Guidelines.md](./security-review/Security_Code_Reviewer_Guidelines.md)
     bundled with this workflow. Use its purpose and rule-loading strategy to guide the review.
